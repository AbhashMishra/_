...
function setup() {
  ...
  rocket1 = createSprite(50,200,width,50);
  ...
  gameOver = createSprite(700,height-480);
  //320
  gameOver.scale = 0.3;
  gameOver.addImage(gameOverImg);
  
  restart = createSprite(690,height-395);
  restart.scale = 0.7;
...
function draw() {  
  ...
  fill("white");
  textSize(15);
  text("T  H  E    I  N  F  I  N  I  T  E    R  O  C  K  E  T",550,250);
  
  fill("white");
  stroke("white");
  strokeWeight(5);
  textSize(59);
  text("G  A  L  A  X  Y",500,220);
...
function spawnAlien(){
 if (frameCount % 250 === 0){
   var alien = createSprite(1900,height-300,width,125);
